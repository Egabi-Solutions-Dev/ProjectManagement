...
@RestController
@RequestMapping("/PM/api/lkp/lkpCurrency")
public class LkpCurrencyController extends LkpController<LkpCurrency,Long>{

    public LkpCurrencyController(@Autowired BaseLkpService lkpCurrencyService){
        super(lkpCurrencyService);
    }
}
