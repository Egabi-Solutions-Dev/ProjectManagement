...
@RestController
@RequestMapping("/PM/api/lkp/lkpSector")
public class LkpSectorController extends LkpController<LkpSector,Long>{

    public LkpSectorController(@Autowired BaseLkpService lkpSectorService){
        super(lkpSectorService);
    }
