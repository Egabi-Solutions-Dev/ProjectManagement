...
@RestController
@RequestMapping("/PM/api/lkp/lkpEngagmentType")
public class LkpEngagmentTypeController extends LkpController<LkpEngagmentType,Long>{

    public LkpEngagmentTypeController(@Autowired BaseLkpService lkpEngagmentTypeService){
        super(lkpEngagmentTypeService);
    }
}
