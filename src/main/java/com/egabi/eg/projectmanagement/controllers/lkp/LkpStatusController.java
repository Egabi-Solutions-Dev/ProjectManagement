...
@RestController
@RequestMapping("/PM/api/lkp/lkpStatus")
public class LkpStatusController extends LkpController<LkpStatus,Long>{

    public LkpStatusController(@Autowired BaseLkpService lkpStatusService){
        super(lkpStatusService);
    }
}
