...
@RestController
@RequestMapping("/PM/api/lkp/attachmentTypes")
public class AttachmentController extends LkpController<LkpAttachmentType,Long>{

    public AttachmentController(@Autowired BaseLkpService lkpAttachmentTypeService){
        super(lkpAttachmentTypeService);
    }
}
