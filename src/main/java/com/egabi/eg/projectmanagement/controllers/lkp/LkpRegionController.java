...
@RestController
@RequestMapping("/PM/api/lkp/lkpRegion")
public class LkpRegionController extends LkpController<LkpRegion,Long>{

    public LkpRegionController(@Autowired BaseLkpService lkpRegionService){
        super(lkpRegionService);
    }
}
