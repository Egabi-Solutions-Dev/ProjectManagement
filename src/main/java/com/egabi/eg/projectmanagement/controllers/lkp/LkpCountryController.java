...
@RestController
@RequestMapping("/PM/api/lkp/lkpCountry")
public class LkpCountryController extends LkpController<LkpCountry,Long>{

    public LkpCountryController(@Autowired BaseLkpService lkpCountryService){
        super(lkpCountryService);
    }
}
