...
@RestController
@RequestMapping("/PM/api/lkp/lkpBusinessLine")
public class LkpBusinessLineController extends LkpController<LkpBusinessLine,Long>{

    public LkpBusinessLineController(@Autowired BaseLkpService lkpBusinessLineService){
        super(lkpBusinessLineService);
    }
}
